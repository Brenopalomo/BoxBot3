...
limitt = 99999999
ban = []
userpremium = ["5516999916885@s.whatsapp.net" , "6285876210829@s.whatsapp.net"] //ubah nomer kalian
		...
		try {
			...
			if (anu.action == 'add') {
				...
				try {
					...
					ppimg = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAy4vNdpwy_4iQdR_sBDVyKECEH6QKcGnkmQ&usqp=CAU'
				}
...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const DenisGans = ["5516999916885@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				wait: '*📦 Aguarde Um pouco Lindo(a)*',
				success: '*📦Sucesso Lindo(a)📦*',
				error: {
					stick: ' *ɢᴀɢᴀʟ, ᴛᴇʀᴊᴀᴅɪ ᴋᴇꜱᴀʟᴀʜᴀɴ ꜱᴀᴀᴛ ᴍᴇɴɢᴋᴏɴᴠᴇʀꜱɪ ɢᴀᴍʙᴀʀ ᴋᴇ ꜱᴛɪᴄᴋᴇʀ*',
					Iv: '*ᴍᴀᴀꜰ ʟɪɴᴋ ᴛɪᴅᴀᴋ ᴠᴀʟɪᴅ!!*'
				},
				only: {
					group: '*❌ Este Comando só presta no Grupo ❌*',
					benned: '*❌ Você Foi Bloqueado de usar este comando ❌*',
					ownerG: '*❌ Este comando só o Dono do grupo que tem acesso ❌*',
					ownerB: '*❌ Este comando quem pode usar somente o dono fo bot ❌* ',
					premium: '*❌ Este comando pertence aos membro Premium ❌*',
					...
					admin: '*❌ Somente o admin do grupo pode usar este comando ❌*',
					Badmin: '*❌ O comando só pode ser usado se o bot for admin ❌*'
				}
			}
			...
			const ownerNumber = ["5516999916885@s.whatsapp.net" , "6285876210829@s.whatsapp.net" , "6281567973372@s.whatsapp.net"] // owner number ubah aja
